...
{
public:
    CrafteoMan(Partida* _partida, int turnos);
    ~CrafteoMan();
    ...
    void crafteoCueva(Panel& panel, sf::Text& texto);
    struct Material obtenerMaterial();
    ...
    //bool pocionCurativa(sf::Text& texto, Panel& panel);
    bool pocionCurativa(sf::Text& texto);
    bool espadaMadera(sf::Text& texto);
    bool espadaHierro(sf::Text& texto);
    bool escudoHierro(sf::Text& texto);
    bool escudoMadera(sf::Text& texto);
