...
const sf::Color CLR_FONDO_PA_JUG = sf::Color(0, 0, 0, 180);

const sf::Color CLR_RECUA_PA_JUG = sf::Color::White;
const sf::Color CLR_RECUA_PA_JUG_RES = sf::Color::Yellow;
...
const unsigned int TAM_CAR_JUG=30;
